...
<html>
<head>
  <title>Chocolate Mousse Square</title>
...
<nav class="w3-sidenav w3-card-2 w3-top w3-xlarge w3-animate-left" style="display:none;z-index:2;width:20%;min-width:300px;background-color:#20A4F3;" id="mySidenav">
  ...
  <a href="login.html" onclick="w3_close()">Login</a>
  <a href="signup.html" onclick="w3_close()">Sign Up</a>
</nav>
...
<!-- Footer -->
  ...
  <div class="w3-xlarge" style="background-color:#C1CFDA;">
    ...
    <a href="dessert.php" class="w3-hover-text-red" title="Go to top"><i class="fa fa-arrow-up"></i></a>
  </div>
